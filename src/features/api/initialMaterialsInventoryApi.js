...
export const updateMaterialsInventoryApi = (quantity, inventory_date, id) => {
    return axios.put(`http://127.0.0.1:8000/api/inventory/update-InitialMaterialInventory/${id}`, {
        quantity: quantity,
        inventory_date: inventory_date,
    },
        {
