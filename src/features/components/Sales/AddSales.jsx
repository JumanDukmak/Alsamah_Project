...
import { resetData_sales, uploadSalesFileFetch } from "../../redux/Sales/salesSlice";
...
const AddSales = () => {
    ...
    const onSubmit = (e) => {
        ...
        dispatch(uploadSalesFileFetch(dataFile))
    };
        ...
        >
            ...
            >
                <Form.Item name="title">
                    ...
                    >يمكن تحميل الملف الخاص بالمبيعات من هنا</Title>
                </Form.Item>
