...
import { getExportSalesStart, getLocalSalesStart, getTotalSalesStart, resetData_distractions
...
const ShowDistractions = () => {
    ...
    }, [report.salesperson_id, report.areas_id, report.saletype, report.local_saletype])
    ...
    return (
        <div className="conatiner_body" >
            ...
            <div style={{ width: '100%', justifyContent: 'center', display: 'flex' }}>
                <Form style={{ width: "70%", padding: "20px" }}
                    layout="vertical"
                    hideRequiredMark
                        ...
                        <Col span={12}>
                            ...
                            >
                                <Select
                                    ...
                                    value={
                                        report.local_saletype == "مندوبين" && report.salesperson_id !== null
