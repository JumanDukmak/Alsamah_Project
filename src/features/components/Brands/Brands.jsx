...
import { getBrandsStart, resetData_brand } from '../../redux/Brands/brandsSlice';
                ...
                <Row gutter={[16, 24]}>
                    {
                        brands.brands.map((Brand, i) => (
                            <Col className="gutter-row" key={i}>
                                ...
                                >
                                    <Meta
                                        avatar={<Avatar style={{ backgroundColor: '#02e079b0', color: 'white' }}>{Brand.name.charAt(0).toUpperCase()}</Avatar>}
                                        title={Brand.name}
